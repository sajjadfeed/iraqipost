                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div id="company_info">
                               ...
                               @include("web.layouts.form.company-info")
                               @include("web.layouts.form.page-info")
                               @include("web.layouts.form.app-info")
                               @include("web.layouts.form.driver-info")
                            </div>
                            <br>
                                ...
                                <div class="border border-1 p-5 rounded">
                                    <div class="form-row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input required type="text" name="alqada" id="alqada_input" class="form-control"
                                                   placeholder="القضاء">
                                        </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            ...
                                            <input required id="almahala_input" name="almahala" type="text" class="form-control"
                                                   placeholder="المحلة">
                                        </div>
                                        <div class="col">
                                            <label for="alziqaq_input">الزقاق</label>
                                            <input required type="text" id="alziqaq_input" name="alziqaq" class="form-control"
                                                   placeholder="الزقاق">
                                        </div>
                                ...
                                <div class="border border-1 p-5 rounded">
                                    <div class="form-row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input required type="number" name="registration_number" id="registration_number_input" class="form-control"
                                                   placeholder="رقم التسجيل">
                                        </div>
                                        <div class="col">
                                            <label for="registration_address_input">عنوان التسجيل</label>
                                            <input required id="registration_address_input" name="registration_address" type="text" class="form-control"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input required type="date"  name="registration_date" id="registration_date_input" class="form-control"
                                                   placeholder="2022-08-28">
                                        </div>
                                        <div class="col">
                                            <label for="registration_type_input">نوع التسجيل</label>
                                            <input required type="text" name="registration_type" id="registration_type_input" class="form-control"
                        ...
                        <div class="col">
                            <div id="company_info">
                                ...
                                <div class="border border-1 p-5 rounded">
                                    <input hidden="" name="photo" id="photo">

                                    <div class="pt-4 pb-4" style="border: 2px dashed;padding: 20px;text-align: center;cursor: pointer" title="التقاط صورة">
                                       <div class="container-fluid">
                                           <div class="row align-items-center" >
                                               <div class="col">
                                                   <canvas id="canvas" width="200" height="200" class="rounded"></canvas>

                                               </div>

                                               <div class="col">
                                                   <div id="cameraModalContainer" data-toggle="modal" data-target="#cameraModal">
                                       ...
                                       <div class="form-row">
                                        <div class="form-group m-0">
                                            ...
                                            @foreach($partner_types as $partner_type)
                                               <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="partnet-type-{{$partner_type->id}}" name="partnet_type"
                                                       class="custom-control-input" value="{{$partner_type->id}}">
                                                <label class="custom-control-label m-0" for="partnet-type-{{$partner_type->id}}">
                                                    {{$partner_type->title}}
                                                </label>
                                            </div>
                                            @endforeach
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col" id="ceo_name_col">
                                            ...
                                            <input required type="text" id="ceo_name_input" name="ceo_name" class="form-control"
                                                   placeholder="اسم المدير المفوض او الشريك">
                                        </div>
                                        <div class="col">
                                            <label for="national_id_number_input">رقم البطاقة الوطنية</label>
                                            <input required id="national_id_number_input" name="national_id_number" type="number" class="form-control"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input required type="text" name="passport_number" id="passport_input" class="form-control"
                                                   placeholder="رقم جواز السفر">
                                        </div>
                                        <div class="col">
                                            <label for="phone_number_input">رقم الهاتف</label>
                                            <input required type="text" name="phone_number" id="phone_number_input" class="form-control"
                                    ...
                                    <div class="border border-1 p-5 rounded">
                                        <div class="form-row">
                                            ...
                                            <div class="col">
                                                ...
                                                <input required type="number" name="cars_count" id="cars_count_input" class="form-control"
                                                       placeholder="عدد العجلات">
                                            </div>
                                            <div class="col">
                                                <label for="motorcycle_count_input">عدد الدراجات المسجلة</label>
                                                <input required id="motorcycle_count_input" name="motorcycle_count" type="number" class="form-control"
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col">
                                                ...
                                                <input required type="number" name="employee_count" id="employee_count_input" class="form-control"
